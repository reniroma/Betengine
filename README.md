...
```bash
./scripts/auto-resolve-merge-conflicts.sh           # defaults to keeping current branch (ours) changes
./scripts/auto-resolve-merge-conflicts.sh --theirs  # keep incoming changes instead
```

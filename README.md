...
```bash
./scripts/auto-resolve-merge-conflicts.sh           # defaults to keeping incoming changes
./scripts/auto-resolve-merge-conflicts.sh --ours    # keep current branch changes instead
```
